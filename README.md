...
A curated collection of links, repositories, and tools for Large Models (LM). Created initially for the simplicity of finding different types of tools for Artificial Intelligence use, as well as recommendations and simple concepts that are easy to understand or well-known.
...
| Sentry MCP                  | MCP server for integrating Sentry with LLM-powered coding agents. Enables natural language queries, debugging, and developer workflows.                                                                                                                         | [Sentry MCP][sentry-mcp-gh]                            | Error Monitoring     |
| MarkItDown MCP              | Lightweight MCP server for converting files and URLs to Markdown. Supports STDIO, HTTP, SSE, and Docker.                                                                                                                                                        | [MarkItDown MCP][markitdown-mcp-gh]                    | Markdown Conversion  |
| Notion MCP Server           | Official MCP server for Notion API. Enables AI agents to search, comment, and create pages in Notion via natural language.                                                                                                                                      | [Notion MCP Server][notion-mcp-gh]                     | Knowledge Management |
